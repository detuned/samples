...
(function ($) {
  ...
  DatePicker = function () {
    var ids = {},
      ...
      tpl = {
        wrapper: '<div class="datepicker"><div class="datepickerBorderT" /><div class="datepickerBorderB" /><div class="datepickerBorderL" /><div class="datepickerBorderR" /><div class="datepickerBorderTL" /><div class="datepickerBorderTR" /><div class="datepickerBorderBL" /><div class="datepickerBorderBR" /><div class="datepickerContainer"><table><tr></tr></table></div></div>',
        head: [
          ...
          '<table cellspacing="0" cellpadding="0">',
            '<thead>',
              '<tr>',
                ...
                '<a class="datepickerMonth" href="#"><span class="calendar__month"></span></a>',
                '<a class="datepickerGoNext" href="#"><span class="calendar__month"><%=next%></span></a></th>',
              '</tr>',
      ...
      defaults = {
        ...
        lastSel: false,
		  ...
		  /**
		   * Key of locale option to get array of months names using in month mode
		   */
	    localeMonthMode : 'monthsShort',
	    enableYearsSelect : true
      },
      ...
      fill = function(el) {
        ...
        for(var i = 0; i < options.calendars; i++) {
          ...
          if(i == 0) tblCal.addClass('calendar');
          if(i == options.calendars - 1) tblCal.addClass('calendar calendar_second');
          ...
          while(cnt < 42) {
            ...
            if (date > today) {
              ...
              data.weeks[indic].days[indic2].classname.push('datepickerFuture','is-disabled');
            }
            
            if (month != date.getMonth()) {
              data.weeks[indic].days[indic2].classname.push('datepickerNotInMonth');
              // disable clicking of the 'not in month' cells
              data.weeks[indic].days[indic2].classname.push('is-disabled');
            }
            if (date.getDay() == 0) {
            ...
            if(options.date && (!$.isArray(options.date) || options.date.length > 0)) {
              if (fromUser.selected || options.date == val || $.inArray(val, options.date) > -1 || (options.mode == 'range' && val >= options.date[0] && val <= options.date[1])) {
                data.weeks[indic].days[indic2].classname.push('is-selected');
              }
			  if ( window.searchDatepickerTo && options._from && (val >= options.date) && (val <= window.searchDatepickerTo.valueOf()) ) {
				  data.weeks[indic].days[indic2].classname.push('highlighted');
			  }
			  if ( window.searchDatepickerFrom && options._to && (val <= options.date) && (val >= window.searchDatepickerFrom.valueOf()) ) {
				  data.weeks[indic].days[indic2].classname.push('highlighted');
			  }
            }
          ...
          data = {
            data: options.locale[ options.localeMonthMode ],
      ...
      click = function(ev) {
        ...
        if (el.is('a')) {
            ...
            if (el.hasClass('datepickerMonth')) {
              ...
              if(options.mode == 'range') {
	            ...
	            if ( options.onModeChange ){
		            options.onModeChange( newMode, prevMode );
	            }
              }
          ...
          } else if (parentEl.is('td') && !parentEl.hasClass('is-disabled')) {
          ...
          if(changed) {
            ...
            if (options._from) {
                $('.datepicker-range-panel__to .datepicker').DatePickerRedraw();
            } 
            if (options._to) {
                $('.datepicker-range-panel__from .datepicker').DatePickerRedraw();
            } 
    ...
    return {
      ...
      init: function(options){
        ...
        if ( $(this).parent().hasClass('datepicker-range-panel__from') ) {
	        options._from = true;
        }
        if ( $(this).parent().hasClass('datepicker-range-panel__to') ) {
	        options._to = true;
        }
      ...
      setMode: function(){
        return this.each(function(){
          if ($(this).data('datepickerId')) {
            var cal = $('#' + $(this).data('datepickerId'));
            var options = cal.data('datepicker');
	        cal.find( '.datepickerMonth' ).trigger( 'click' );
          }
        });
      },
      ...
      getMode: function(){
	      if ( $( this ).data( 'datepickerId' ) ){
		      var cal = $( '#' + $( this ).data( 'datepickerId' ) );
		      var $calendar = cal.find( '.calendar' );
		      if ( $calendar.hasClass( 'datepickerViewDays' ) ){
			      return 'days';
		      }
		      else if ( $calendar.hasClass( 'datepickerViewMonths' ) ){
			      return 'months';
		      }
		      else if ( $calendar.hasClass( 'datepickerViewYears' ) ){
			      return 'years';
		      }
	      }
      },
